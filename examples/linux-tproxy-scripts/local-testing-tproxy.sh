...
iptables -t mangle -A PREROUTING -p tcp --dport 443 -d 216.58.204.46 -j TPROXY --tproxy-mark 0x1/0x1 --on-port 9000
iptables -t mangle -A OUTPUT -p tcp -m socket -j DIVERT
iptables -t mangle -A OUTPUT -p tcp --dport 443 -d 216.58.204.46 -j TPROXY --tproxy-mark 0x1/0x1 --on-port 9000
